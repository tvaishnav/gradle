...
TODO:DAZ Revisit if this breakage is necessary and/or reasonable. Perhaps we should retain the 'orginal' target mapping for Tooling clients that are not composite-aware.
